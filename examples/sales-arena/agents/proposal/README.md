...
Deterministic 3-tier proposal composer for the Sales Arena ([SALES-ARENA-FLAGSHIP-PLAN.md §5](../../../../examples/sales-arena/README.md)).
...
- Live persona-pack loader that reads `examples/sales-arena/personas/*/proposals/{starter,pro,enterprise}.md` and feeds the value props through `ProposalContext`.
